...
注解：
     【画风主体】：这部分是画面的“灵魂”，建议由4到8个画师的名字组成，它们将决定画面的核心风格。请将这些画师词条放在整个提示词的最前面，确保它们拥有最高的权重和最直接的影响力。尽量不要超过12个画师。
     在选择画师时，请根据您的主题和期望的视觉效果，选择风格相近或能够互补的画师。例如，如果您需要仿碧蓝档案的画风，可以选用为其绘制过原画的画师（如mx2j）。
