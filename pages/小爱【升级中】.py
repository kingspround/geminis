...
####1，画风（最难的部分）
     ...
     画风部分还可以添加这些元素作为辅助：画风（ink，pixel_art，1990s，4koma），素描（sketch，realistic，monochrome），写实（photorealistic，oil_painting），作品（umamusume，princess_connect!，girl_frontline）等等
