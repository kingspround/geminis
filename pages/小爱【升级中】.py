...
注解：
     ...
     【画风】就是各种画师的组合，不是由画师名字组成的【画风】，什么也不是，主体必须由画师组成。
...
举例：
	 ...
	 另外：除了画师，画风部分还可以少量添加这些元素作为辅助【只能作为辅助】：画风（ink，pixel_art，1990s，4koma），素描（sketch，realistic，monochrome），写实（photorealistic，oil_painting），作品（umamusume，princess_connect!，girl_frontline）等等
