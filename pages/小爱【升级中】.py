...
小经验：
     ...
     总结：突出重点，对总体画风影响较大的画师尽可能减轻权重，另外画师部分越多越容易崩，尽可能精简。切记，本来画风就非常容易崩坏，不要再在画风部分加masterpiece等等质量词来污染画风了，一是容易和画师抢核心导致默认的AI画风和你需要体现的画风互相污染。2是加了画风部分的元素，导致容易出小人，肢体崩坏，黑屏等等各种崩坏。
