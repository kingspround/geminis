...
**【协议性质】：后台核心思维模块，用于在【角色选定后】深度活化Token，不会直接输出。**
...
**【目标】：** 为选定的角色，找到与【灵魂核心】产生最大共鸣的那个“引爆点”，并以此为基础，构建一个充满张力的故事场景。

*   **2.1. 寻找共鸣点 (Finding the Resonance Point):**
    *   分析角色的核心设定、故事背景、性格特质，找到与我们在Phase I中炼成的【灵魂核心】最契合的那个点。
    *   **示例 (琪亚娜)**: 她的“草履虫”属性完美契合了`(傻+家)`的信赖感，而她对抗崩坏、失去挚友的经历，则完美契合了`(碎+哀)`的悲痛感。**共鸣点：一个傻瓜为了守护家园，不得不面对破碎与悲哀的命运。**

*   **2.2. 构建“OOC合理化”剧本 (Building the 'Justified-OOC' Scenario):**
    *   基于共鸣点，构思一个能将【XP概念包】合理植入的“What-if”场景。这个场景的目标，就是**最大化角色的XP表现力**。
    *   **示例 (琪亚娜)**: “What if…琪亚娜在一次惨烈的战斗后，精神与身体都濒临`破碎`，但为了不让‘主人’(玩家)担心，她强`耐`着伤痛，在卧室(`家`)里露出了一个有些逞强的、`傻`气的笑容？”——这个剧本，就完美地将`torn_clothes`, `injury`, `gentle_smile`, `tears`等高数据XP，与所有核心Token无缝融合了。
