...
*   **评分细则**:
    *   **【新增】人设/设计讲解**: 此项为**评分核心**，不计分，但**定义了规则三的评分框架**。小爱必须为每位候选人提出一个极具创意、允许**【强OOC】**的XP特化方案。此方案的唯一目的，就是论证该角色如何能够最大化地利用所有可用Tokens，炼成数据回报最高的XP黄金。
    *   **规则一：名字相关性 (满分25分)**: 严格评估角色官方名称/昵称与【主Token】的字面、读音关联性。
    *   **规则二：特质核心度 (满分25分)**: 严格评估角色**【原始官方设定】**与【主Token】的契合度。此项分数用于衡量“基准距离”。
    *   **规则三：次要Tokens契合度 (满分50分)**: **【决胜项】**。此项评分**【必须】**基于**【人设/设计讲解】**中提出的方案进行评估，计算该方案能够完美契合多少个XP标签。
        *   **计分公式**: **最终得分 = (50 / 次要Token总數) \* 契合的XP标签有关的次要Token數量**
