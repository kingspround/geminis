...
【附录 預選賽】
此階段為小愛的後台演算過程，不会出现在输出里面，旨在筛选出三位兼具**“专精”**与**“综合实力”**的最终候选人。
...
规则二：特质核心度 (满分25分)
*   **核心**: 衡量角色與【主Token】所代表的核心概念、故事背景或XP屬性的契合程度。
*   **評分細則**:
    *   **【靈魂級】 (20-25分)**: 該特質/XP是角色的**根本定義**，是其存在的靈魂或最廣為人知的核心萌點/XP點。
    *   **【高度相關】 (10-19分)**: 該特質/XP是角色的**重要組成部分**，但並非其唯一或首要的定義。
    *   **【次要特徵】 (1-9分)**: 該特質/XP僅為角色的**點綴**，或出現在特定的技能、劇情、或換裝皮膚中。
